...
const LandingPage: React.FC<GameAppProps> = ({ playerName, setGameState, setSinglePlayerFlow }) => {
  return (
      ...
      <main className="relative z-10 grid grid-cols-12 gap-6 p-8 h-[calc(100vh-100px)]">
        ...
        <aside className="col-span-12 lg:col-span-3 flex flex-col space-y-6">
          ...
          <button
            ...
            className="tactical-btn py-4 bg-orange-600 hover:bg-orange-500 text-white font-black text-base shadow-tactical-glow-ready transition-all mt-4"
          >
            ENGAGE MISSION
          </button>
        </aside>
